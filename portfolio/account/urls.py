...
from portfolio.account.views import SignUpView, SignOutView, SignInView, AppUserChangePassword, ProfileDetailsView, \
    ProfileEditView, user_delete, AppUserHistoryListView, AccountHistoryListView
...
urlpatterns = [
    ...
    path('history/', AccountHistoryListView.as_view(), name='transactions history'),
    path('history-api/', AppUserHistoryListView.as_view(), name='transactions history api'),
